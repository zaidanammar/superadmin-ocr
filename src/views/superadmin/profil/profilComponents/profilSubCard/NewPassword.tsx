      ...
      <div className='relative w-full px-5 py-4 max-w-full'>
          ...
          <div>
            ...
            <div>
              <h1 className='font-normal text-sm text-gray-500'>
                Password akan digunakan untuk login, Masukkan minimal 6 karakter
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className='mt-3 flex'>
          <input
            ...
            className='font-normal text-sm w-full'
          />
          <button className='ml-4' onClick={handleVisibleRetype}>
            {retype === 'password' ? (
              <svg
                width='22'
                height='16'
        ...
        <div className='mt-3 flex'>
          {password === rePassword ? (
            ...
            <h1 className='text-red-500 font-normal text-xs'>
              Terjadi kesalahan
            </h1>
          )}
        </div>
