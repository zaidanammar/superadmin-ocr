...
export default function PicInformation() {
            ...
            <div className="w-full xl:w-full xl:mb-3 bg-white shadow-lg px-3 py-3 mt-4">
                ...
                <div className="flex items-center ml-3 my-5">
                    ...
                    <div className="ml-5 w-1/6">
                        ...
                        <div className="flex justify-between">
                            <h1 className="font-normal text-base text-abuabu">pic</h1>
                        </div>
                        <div className="flex justify-between">
                            <h1 className="font-normal text-base text-yellow-400">Pic42221</h1>
                        </div>
